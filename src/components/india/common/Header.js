        ...
        <div className="flex items-center justify-between h-20 px-6">
          ...
          <div className="items-center hidden space-x-8 md:flex">
            ...
            <Link href="/visa/step-one">
              <span className="inline-flex items-center px-6 py-2.5 text-sm font-medium text-white bg-blue-600 rounded-full hover:bg-blue-700 transition-colors">
                Start Application
                <svg
          ...
          <nav className="divide-y divide-gray-100">
            ...
            <div className="p-4">
              <Link
                ...
                className="block w-full py-3 text-center text-white transition-colors bg-blue-600 hover:bg-blue-700 rounded-lg"
              >
                Start Application
              </Link>
            </div>
